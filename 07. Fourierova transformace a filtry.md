...
- Pro periodický signál $x(t)$ lze zapsat jako:
  ...
  - $\varphi_k = \arg(X_k) = \frac{\operatorname{Im}(X_k)}{\operatorname{Re}(X_k)}$.
...
- Je definována jako
  ...
  $$
  X[k] = \frac{1}{N}\sum_{n=0}^{N-1} x[n] e^{-j 2\pi k n / N}, \quad k = 0, 1, \ldots, N-1,
  $$
...
- Existují dva hlavní typy:
  ...
  - IIR (Infinite Impulse Response)
    ...
    - mohou mít záporné mocniny v z-transformaci, což znamená, že jejich přenosová funkce může mít póly mimo počátek,
    - v z-rovině mohou mít póly mimo jednotkovou kružnici, což může vést k nestabilitě a nelineární fázi.
